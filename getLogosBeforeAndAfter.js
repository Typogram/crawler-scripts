 ...
 * URL: https://www.underconsideration.com/brandnew/archives/category/type/before_after
 *
 * Usage:
...
(function() {
    ...
    function updateLogosArray() {
        ...
        var logosArray = JSON.parse(localStorage.getItem('before_after_logos')) || [];
        ...
        localStorage.setItem('before_after_logos', JSON.stringify(logosArray));
    ...
    function extractDataFromGridItem(gridItem) {
        ...
        let projectType = 'Before and After';
